...
Although DecodeBot has no external dependencies, a `requirements.txt` file can be added as a best-practice placeholder:
...
A `.gitignore` file is recommended to keep generated and environment-specific files out of version control:
